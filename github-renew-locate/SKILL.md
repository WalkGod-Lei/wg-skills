...
| GitHub | 工具类 | github-tuisong + github-renew-locate |
...
- GitHub: skill 在根目录子文件夹（如 `github-tuisong/`）
...
如需从多个仓库拉取多个 skill，按仓库分组依次执行：
    ...
    示例：从 GitHub 拉取 github-tuisong
    1. 列远程：gh api repos/WalkGod-Lei/GitHub/contents/github-tuisong
    2. 下载到本地：~/.qoderworkcn/skills/github-tuisong/
